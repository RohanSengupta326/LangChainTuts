...
#     sentiment: Annotated[Literal['Positive', 'Negative', 'Neutral'], 'analyse the sentiment of the review is positive, negative or neutral']
#     pros: Annotated[Optional[list[str]], 'If the review has some pros explicity mentioned as pros then consider those and return']
#     cons: Annotated[Optional[list[str]], 'If the review has some cons explicity mentioned as cons then consider those and return']
#     reviewer: Annotated[Optional[str], 'If the name of reviewer is present in the review then return that']
...
json_review = {
    ...
    "properties": {
        ...
        "sentiment": {
            ...
            "description": "analyse the sentiment of the review is positive, negative or neutral",
        },
        "pros": {
            "type": ["array", "null"] ,
            "items": {
            ...
            "description": "If the review has some pros explicity mentioned as pros then consider those and return",
        },
        "cons": {
            "type": ["array", "null"] ,
            "items": {
            ...
            "description": "If the review has some cons explicity mentioned as cons then consider those and return",
        },
        "reviewer": {
            "type": ["string", "null"],
            "description": "If the name of reviewer is present in the review then return that",
        }
    },
    "required": ["summary", "topics", "rating"],
}


structured_output_model = model.with_structured_output(json_review)
